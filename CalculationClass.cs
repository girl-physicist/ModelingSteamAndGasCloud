...
namespace SteamAndGasCloud
{
    internal class CalculationClass
    {
        ...
        // P[i+1]
        public double СalculatePressureOfSteamGasMixture(double deltaFunk, double constA, double constB, double currentTime, double tDelta, double Ui, double Vi, double ro1i, double ro2i, double pi, double Ti)
        {
            return GetAcomponentFromPi(currentTime, tDelta, Vi, Ui, Ti) * GetBcomponentFromPi(deltaFunk, constA, constB, currentTime, tDelta, Ui, Vi, ro1i, ro2i, pi);
        }
        // T[i]
        ...
        {
            return roi * cp * GetValueDeltaRDeltaT(tDelta, value, currentTime - tDelta, currentTime);
        }
        ...
        private double GetAcomponentFromPi(double currentTime, double tDelta, double Vi, double Ui, double Ti)
        {
            var up = ClassConst.universalGasConstant * Ti;
